...
call_summary_pers(FILE *outf)
{
	...
	static const struct {
		...
		[CSC_TIME_100S]  = { ARRSZ_PAIR("% time") },
		[CSC_TIME_MIN]   = { ARRSZ_PAIR("shortest") },
		[CSC_TIME_MAX]   = { ARRSZ_PAIR("longest") },
		/* Historical field sizes are preserved */
		[CSC_TIME_TOTAL] = { "seconds",    12 },
		[CSC_TIME_AVG]   = { "usecs/call", 12 },
		[CSC_CALLS]      = { "calls",      10 },
		[CSC_ERRORS]     = { "errors",     10 },
		[CSC_SC_NAME]    = { "syscall",    17, CF_L },
	};
